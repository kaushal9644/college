 ...
 <div class="subnav">
  ...
  <button class="subnavbtn">Faculty <i class="fa fa-caret-down"></i></button>
    <div class="subnav-content">
      ...
      <form action="../../AdminStudentUpdate" method="post">
      <h1>Update Profile</h1>
      
      <div class="form-group">
        <label>Student ID</label>
        <input type="text" name="sid"  placeholder="S id" required>
      </div>
      <div class="form-group">
      ...
      <div class="form-group ">
        ...
        <input type="text" name="sfname" placeholder="Father name" required>
      </div>
       <div class="form-group ">
        <label>Gender</label>

  ...
  <button class="subnavbtn">Faculty <i class="fa fa-caret-down"></i></button>
    <div class="subnav-content">
      ...
      <a href="TeacherUpdate.jsp">Update</a>
        ...
        <form action="../../AdminTeacherUpdate" method="post">
      <h1>Update Your Profile </h1>
     
      <div class="form-group">
        <label>Faculty ID</label>
        <input type="text" name="tid" placeholder="Faculty Id" required>
      </div>
      <div class="form-group">
        <label>Faculty Full Name</label>
        <input type="text" name="tname" placeholder="Full Name" required>
      </div>
      <div class="form-group ">
        <label>Faculty Father's Name</label>
        <input type="text" name="tfname" placeholder="Father name" required>
      </div>
       <div class="form-group ">
        <label>Gender</label>

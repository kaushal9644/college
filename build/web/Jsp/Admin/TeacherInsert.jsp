    ...
    <div class="subnav-content">
      ...
      <a href="TeacherUpdate.jsp">Update</a>
        ...
        <div class="main-content-area" id="main-content-area">
            ...
            <form action="../../TeacherDataInsert" method="post">
      <h2>Insert Data Of Faculty</h2>
     
      <div class="form-group">
        <label>Faculty ID</label>
        <input type="text" name="tid" placeholder="Enter Faculty Id" required>
      </div>
      <div class="form-group">
        <label>Faculty Full Name</label>
        <input type="text" name="tname" placeholder="Enter Full name" required>
      </div>
      <div class="form-group ">
        <label>Teacher Father's Name</label>
        <input type="text" name="tfname" placeholder="Enter Father's  name" required>
      </div>
       <div class="form-group ">
        <label>Gender</label>
